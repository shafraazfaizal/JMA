...
interface CampaignDetailClientProps {
    campaign: DBCampaign;
    updates: DBCampaignUpdate[];
    related: DBCampaign[];
}

export default function CampaignDetailClient({ campaign, updates, related }: CampaignDetailClientProps) {
                    ...
                    <div style={{ position: "sticky", top: "90px" }}>
                            ...
                            <div style={{ padding: "1.5rem 1.5rem 1.25rem" }}>
                                ...
                                >
                                    {[
                                        ...
                                        { value: `${campaign.donor_count}`, label: "donors" },
                                        { value: campaign.days_remaining !== null ? `${campaign.days_remaining}` : "—", label: "days left" },
                                    ].map(({ value, label }) => (
                            ...
                            >
                                ...
                                <div>
                                    <p style={{ fontFamily: "var(--font-inter)", fontWeight: 600, fontSize: "0.875rem", color: "#DC2626", marginBottom: "0.2rem" }}>
                                        Urgent — {campaign.days_remaining} days remaining
                                    </p>
                        ...
                        >
                            ...
                            <p style={{ fontFamily: "var(--font-inter)", fontSize: "0.875rem", color: "#0D5C6B", fontWeight: 500 }}>
                                <strong>{campaign.donor_count} people</strong> have already donated to this campaign
                            </p>
                        </div>
                            ...
                            {related.map((c) => {
                                ...
                                return (
                                    <Link key={c.id} href={`/campaigns/${c.slug}`} style={{ textDecoration: "none" }}>
                                        ...
                                        >
                                            <div style={{ height: "120px", background: c.image_url ? `url(${c.image_url}) center/cover` : "linear-gradient(135deg, #0D5C6B 0%, #1a7a8f 50%, #073D47 100%)", position: "relative" }}>
