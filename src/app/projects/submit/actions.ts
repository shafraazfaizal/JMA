      ...
      <div style="font-family: Arial, sans-serif; max-width: 560px; margin: 0 auto; color: #111827;">
        ...
        <div style="background: #ffffff; padding: 32px 24px; border: 1px solid #E5E7EB; border-top: none; border-radius: 0 0 8px 8px;">
          ...
          <p style="margin: 0 0 16px; color: #374151; line-height: 1.6;">
            JazakAllah Khair for submitting your project request to JMA. We have received your submission and the committee will review it إن شاء الله.
          </p>
