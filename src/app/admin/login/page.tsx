            ...
            <div style={{ maxWidth: "400px", width: "100%", position: "relative", zIndex: 1 }}>
                ...
                <div style={{ textAlign: "center" as const, marginBottom: "2rem" }}>
                    <Image
                        ...
                        height={56}
                        priority
                        style={{ height: "52px", width: "auto", margin: "0 auto 1.25rem", display: "block" }}
                    />
                ...
                >
                    ...
                    <div style={{ marginBottom: "1.25rem" }}>
                        <label style={{ display: "block", fontFamily: "var(--font-inter)", fontWeight: 600, fontSize: "0.8125rem", color: "#374151", marginBottom: "0.5rem" }}>
                            Email
                        </label>
                        <input
                            type="email"
                            placeholder="admin@jaffnamuslimuk.org"
                            value={email}
                            onChange={(e) => { setEmail(e.target.value); setError(""); }}
                            onKeyDown={(e) => { if (e.key === "Enter") handleLogin(); }}
                            style={{ width: "100%", padding: "0.8125rem 1rem", borderRadius: "0.5rem", border: "1.5px solid #E5E7EB", fontFamily: "var(--font-inter)", fontSize: "0.9375rem", color: "#111827", outline: "none", boxSizing: "border-box" as const, transition: "border-color 0.15s ease" }}
                    ...
                    <div style={{ marginBottom: "1.75rem" }}>
                        ...
                        <div style={{ position: "relative" }}>
                            <input
                                ...
                                onKeyDown={(e) => { if (e.key === "Enter") handleLogin(); }}
                                style={{ width: "100%", padding: "0.8125rem 2.75rem 0.8125rem 1rem", borderRadius: "0.5rem", border: "1.5px solid #E5E7EB", fontFamily: "var(--font-inter)", fontSize: "0.9375rem", color: "#111827", outline: "none", boxSizing: "border-box" as const, transition: "border-color 0.15s ease" }}
                                onFocus={(e) => { (e.target as HTMLInputElement).style.borderColor = "#0D5C6B"; }}
                                onBlur={(e) => { (e.target as HTMLInputElement).style.borderColor = "#E5E7EB"; }}
                            />
                            <button
                    ...
                    <button
                        onClick={handleLogin}
                        disabled={loading}
                        style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "center", gap: "0.5rem", padding: "0.9375rem", borderRadius: "0.5rem", border: "none", backgroundColor: loading ? "#094955" : "#0D5C6B", color: "#ffffff", fontFamily: "var(--font-jakarta)", fontWeight: 700, fontSize: "0.9375rem", cursor: loading ? "not-allowed" : "pointer", transition: "background-color 0.2s ease" }}
                ...
                <p style={{ textAlign: "center" as const, fontFamily: "var(--font-inter)", fontSize: "0.8125rem", color: "rgba(255,255,255,0.35)", marginTop: "1.5rem" }}>
